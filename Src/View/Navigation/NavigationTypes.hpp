 ...
 * @details This is UI-only operational tracking state, stored in
 * NavigationManager, not in the FSM or UIFSMAdapter. It tracks which navigation
 * operation is currently active for proper event handling.
 */
 ...
 * @details Defines the point around which the camera orbits during 3D
 * navigation. This is domain state stored in UIFSMAdapter.
 */
